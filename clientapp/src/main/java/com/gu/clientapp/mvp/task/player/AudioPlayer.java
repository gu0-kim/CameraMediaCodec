package com.gu.clientapp.mvp.task.player;
...
public class AudioPlayer {
  ...
  public AudioPlayer(int frequency, int channel, int sampleBit) {
  ...
  public int getMinBufferSize() {
    return AudioTrack.getMinBufferSize(mFrequency, mChannel, mSampleBit);
  }
}
